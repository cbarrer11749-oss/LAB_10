...
# Opcional: vuelos a Cusco (plan_cusco_trip) — https://serpapi.com/google-flights-api
...
Export the tool using LangChain tool(...).
Register it in src/agent/createAgent.ts.
Update src/agent/prompt.ts to describe when to use it.
Notes
